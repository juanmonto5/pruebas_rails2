...
class TorresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create torre" do
    assert_difference('Torre.count') do
      post torres_url, params: { torre: { nombre_portero: @torre.nombre_portero, nombre_torre: @torre.nombre_torre } }
    end
  ...
  test "should update torre" do
    patch torre_url(@torre), params: { torre: { nombre_portero: @torre.nombre_portero, nombre_torre: @torre.nombre_torre } }
